...
const changelog_schema_1 = require("./schemas/changelog.schema");
const notifications_service_1 = require("../notifications/notifications.service");
let ChangelogService = class ChangelogService {
    constructor(changelogModel, notificationsService) {
    ...
    async create(data) {
        ...
        await this.notificationsService.sendChangelogNotification(data.titulo, data.descripcion, data.version);
        return saved;
    }
};
...
exports.ChangelogService = ChangelogService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(changelog_schema_1.Changelog.name)),
